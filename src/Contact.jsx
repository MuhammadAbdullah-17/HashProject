...
const Contact = () => {
  return (
    <div className="container" id="Contact">
      ...
      <div  className="form mt-5 col-12 col-sm-12 col-md-12" >
          <input className="fh col-10 col-md-6 col-sm-10" id="fn" type="text" placeholder="First Name" size="65"/>
          <input className="fh col-10 col-md-6 col-sm-10" id="ln" type="text" placeholder="Last Name" size="65" />
          <br />
