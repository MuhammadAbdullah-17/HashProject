...
const Contact = () => {
  return (
    <div className="container">
      <div className="row mt-3 text-center" data-aos="fade-left" data-aos-duration="1500">
        <h2>Get Quote</h2>
      ...
      <div  className="form mt-5 col-10 col-sm-10 col-md-10 mx-auto" data-aos="fade-up" data-aos-duration="1300">
